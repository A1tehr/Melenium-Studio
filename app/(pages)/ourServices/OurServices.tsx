...
export const OurServicesPage: FC = () => {
  ...
  return (
    <>
      <TitleBannerPage
        title="Наши услуги"
        subtitle="Что мы разрабатываем"
        description="Мы разрабатываем сайты любой сложности: от простых одностраничных до интернет-магазинов. Неизменным остается одно: качество нашей работы и внимание к деталям."
      />
